...
import { ChevronRight, Mail, MessageSquare, Star, PhoneIcon as WhatsApp } from 'lucide-react'
      ...
      <div className="py-20 bg-gradient-to-t from-black to-red-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            >
              <WhatsApp className="w-6 h-6 text-red-500" />
              <div>
            ...
            <a
              href="mailto:support@childofnasdaqofficial.co.za"
              className="flex items-center gap-4 p-4 rounded-lg bg-black/50 border border-red-500/30 hover:border-red-500 transition-colors"
            >
              <Mail className="w-6 h-6 text-red-500" />
              <div>
                <p className="font-semibold text-red-400">Email</p>
                <p className="text-sm text-gray-400">support@childofnasdaqofficial.co.za</p>
              </div>
              <ChevronRight className="w-5 h-5 text-red-500 ml-auto" />
            </a>
            <div className="flex items-center gap-4 p-4 rounded-lg bg-black/50 border border-red-500/30">
              <MessageSquare className="w-6 h-6 text-red-500" />
              <div>
                <p className="font-semibold text-red-400">Live Chat</p>
